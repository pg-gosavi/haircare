...
import { Bell, Lock, LogOut, ChevronRight, User, CircleHelp as HelpCircle, CreditCard as Edit, Building2 as Clinic } from 'lucide-react-native';
      ...
      <ScrollView style={styles.content}>
        <View style={styles.profileSection}>
          <View style={styles.profileInfo}>
            ...
            <View>
              ...
              <Text style={styles.profileEmail}>dr.smith@example.com</Text>
            </View>
          </View>
        ...
        <View style={styles.settingsCard}>
          ...
          <TouchableOpacity style={styles.settingsItem}>
            <View style={styles.settingsItemLeft}>
              <View style={[styles.settingsIcon, { backgroundColor: COLORS.primaryLight }]}>
                <Clinic size={18} color={COLORS.primary} />
              </View>
              <Text style={styles.settingsItemText}>Clinic Settings</Text>
            </View>
            <ChevronRight size={18} color={COLORS.textLight} />
          </TouchableOpacity>
        </View>
